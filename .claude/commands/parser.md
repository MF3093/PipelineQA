...
Read and execute the agent definition at `.claude/agents/parser.md` exactly as written.
...
1. Follow the Parser's Role, Rules, Trigger Conditions, and Execution Steps from `.claude/agents/parser.md` exactly
...
Follow the Exception Handling table in `.claude/agents/parser.md` for:
- Missing raw files
